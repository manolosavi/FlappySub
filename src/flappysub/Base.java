...
public class Base {
	 ...
	 * @param v es las <code>vidas</code> del objeto.
	 * @param a es la <code>animacion</code> del objeto.
	 */
	public Base(int x, int y, int v, Animacion a) {
		posX = x;
		posY = y;
		vidas = v;
		anim = a;
	...
	*/
	...
	public Image getImage(int n) {
		return anim.getImagen(n);
	}
	
	/**
	 * Metodo de acceso que regresa si se esta moviendo el objeto 
	 * @return moviendose es el <code>bool</code> del movimiento del objeto.
	 */
	 ...
	 * @return vidas es las <code>vidas</code> del objeto.
	 */
	public int getLives() {
		return vidas;
	}
	...
	/**
	 * Metodo modificador usado para determinar si el objeto se esta moviendo 
	 * @param m es la <code>booleano de moverse</code> del objeto.
	 */
	...
	/**
	 * Metodo modificador usado para poner las vidas que tiene 
	 * @param m es la <code>vidas que le das</code> del objeto.
	 */
	 public void setLives(int m){
	 	vidas = m;
	}
	 
	 /**
	 * Metodo modificador usado para aumentar vidas
	 * @param m es las <code>vidas</code> para aumentar.
	 */
	 public void addLives(int m){
	 	vidas += m;
	}
	 ...
	 * @param y es la <code>velocidad en y</code> del objeto.
	 */
	 ...
	 * @return velY es la <code>velocidad en y</code> del objeto.
	 */
	public int getVelY() {
		return velY;
	}
